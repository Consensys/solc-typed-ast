...
const cases: Array<[string, any]> = [
    ["test/samples/solidity/declarations/contract_0413.sol", undefined],
    ["test/samples/solidity/declarations/contract_050.sol", undefined],
    ["test/samples/solidity/declarations/interface_060.sol", undefined],

    ["test/samples/solidity/expressions/assignment.sol", undefined],
    ["test/samples/solidity/expressions/binary_operation_0413.sol", undefined],
    ["test/samples/solidity/expressions/binary_operation_050.sol", undefined],
    ...
    ["test/samples/solidity/expressions/tuple.sol", undefined],
    ["test/samples/solidity/expressions/unary_operation_0413.sol", undefined],
    ["test/samples/solidity/expressions/unary_operation_050.sol", undefined],

    ["test/samples/solidity/meta/pragma.sol", undefined],
    ["test/samples/solidity/meta/three_simple_contracts.sol", undefined],
    ["test/samples/solidity/meta/using_for.sol", undefined],
...
describe(`replaceNode() validation`, () => {
    for (const [sample, compilerSettings] of cases) {
