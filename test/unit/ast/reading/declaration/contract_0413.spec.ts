...
describe("ContractDefinition (Solc 0.4.13)", () => {
    ...
    it("library A", () => {
        ...
        expect(contract.vFunctions[0].canonicalSignature).toEqual("add(uint256,uint256)");
        expect(contract.vFunctions[0].canonicalSignatureHash).toEqual("771602f7");
    ...
    it("interface B", () => {
        ...
        expect(contract.vFunctions[0].isConstructor).toEqual(false);
        expect(contract.vFunctions[0].canonicalSignature).toEqual("some(uint256,uint256)");
        expect(contract.vFunctions[0].canonicalSignatureHash).toEqual("cdb3deb6");
    ...
    it("contract C", () => {
        ...
        expect(contract.vFunctions[0].canonicalSignature).toEqual("");
        expect(contract.vFunctions[0].canonicalSignatureHash).toEqual("");
        ...
        expect(contract.vFunctions[1].canonicalSignature).toEqual("some(uint256,uint256)");
        expect(contract.vFunctions[1].canonicalSignatureHash).toEqual("cdb3deb6");
