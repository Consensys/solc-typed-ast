...
describe("Conditional (Solc 0.4.13)", () => {
    const sample = "test/samples/solidity/expressions/conditional_0413.json";
    ...
    before(() => {
        ...
        const { data } = compileJson(sample, "0.4.13", []);
    ...
    it(`Check conditional statement (simple)`, () => {
        ...
        expect(statement.src).toEqual("131:16:0");
        ...
        expect(trueExpression.src).toEqual("140:2:0");
        ...
        expect(falseExpression.src).toEqual("145:2:0");
    ...
    it(`Check conditional statement (nested)`, () => {
        ...
        expect(statement.src).toEqual("238:81:0");
        expect(statement.type).toEqual(Conditional.name);
        ...
        expect(condition.src).toEqual("238:23:0");
        ...
        expect(conditionExpression.src).toEqual("239:21:0");
        ...
        expect(conditionExpression.vCondition.src).toEqual("239:6:0");
        ...
        expect(conditionExpression.vTrueExpression.src).toEqual("248:4:0");
        ...
        expect(conditionExpression.vFalseExpression.src).toEqual("255:5:0");
        ...
        expect(trueExpression.src).toEqual("276:15:0");
        ...
        expect(trueExpression.vCondition.src).toEqual("276:6:0");
        ...
        expect(trueExpression.vTrueExpression.src).toEqual("285:2:0");
        ...
        expect(trueExpression.vFalseExpression.src).toEqual("290:1:0");
        ...
        expect(falseExpression.src).toEqual("306:13:0");
        ...
        expect(falseExpression.vCondition.src).toEqual("306:5:0");
        ...
        expect(falseExpression.vTrueExpression.src).toEqual("314:1:0");
        ...
        expect(falseExpression.vFalseExpression.src).toEqual("318:1:0");
    ...
    it(`Check conditional statement (with complex expressions)`, () => {
        ...
        expect(statement.src).toEqual("422:42:0");
        expect(statement.type).toEqual(Conditional.name);
        expect(statement.typeString).toEqual("uint256");
        ...
        expect(condition.src).toEqual("422:10:0");
        expect(condition.type).toEqual(BinaryOperation.name);
        expect(condition.typeString).toEqual("bool");
        expect(condition.operator).toEqual("==");
        expect(condition === statement.vCondition).toEqual(true);
        ...
        expect(trueExpression.src).toEqual("435:17:0");
        ...
        expect(falseExpression.src).toEqual("455:9:0");
