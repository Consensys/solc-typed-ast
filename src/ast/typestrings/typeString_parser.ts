...
function peg$parse(input: string, options?: IParseOptions) {
  ...
  const peg$c166 = function(): any { return parseInt(text()); };
  const peg$c167 = "-";
  ...
  const peg$c176 = function(): any { return [undefined, false]; };
  const peg$c177 = function(literal: any): any { return options.factory.makeStringLiteralTypeName(text(), literal[0], literal[1]); };
  const peg$c178 = "...(";
  const peg$c179 = peg$literalExpectation("...(", false);
  const peg$c180 = ")...";
  const peg$c181 = peg$literalExpectation(")...", false);
  const peg$c182 = function(prefix: any): any { return options.factory.makeIntLiteralTypeName(text(), prefix); };
  const peg$c183 = "/";
  const peg$c184 = peg$literalExpectation("/", false);
  const peg$c185 = function(numerator: any, denominator: any): any { throw new Error(`NYI Int literal type: ${text()}`); };
  const peg$c186 = function(): any { return options.factory.makeElementaryTypeName(text(), "bool"); };
  const peg$c187 = function(payable: any): any {
  ...
  const peg$c191 = function(width: any): any { return options.factory.makeElementaryTypeName(text(), text()); };
  const peg$c192 = function(): any { return options.factory.makeElementaryTypeName(text(), text());};
  const peg$c193 = function(): any { return options.factory.makeElementaryTypeName(text(), text()); };
  const peg$c194 = ".";
  const peg$c195 = peg$literalExpectation(".", false);
  const peg$c196 = function(name: any): any {
      return makeUserDefinedType(name, text(), options.version, StructDefinition, options.factory, options.ctx);
    };
  const peg$c197 = function(name: any): any {
      return makeUserDefinedType(name, text(), options.version, EnumDefinition, options.factory, options.ctx);
    };
  const peg$c198 = function(name: any): any {
  ...
  const peg$c201 = function(keyType: any, valueType: any): any {
      return options.factory.makeMapping(text(), keyType, valueType)
    };
  const peg$c202 = ",";
  const peg$c203 = peg$literalExpectation(",", false);
  const peg$c204 = function(head: any, tail: any): any { return tail.reduce((lst, cur) => { lst.push(cur[3]); return lst; }, [head]); };
  const peg$c205 = function(): any { return []; };
  const peg$c206 = function(head: any, tail: any): any { return tail.reduce((acc, cur) => { acc.push(cur[1]); return acc}, [head])};
  const peg$c207 = function(name: any, args: any, decorators: any, returns: any): any { 
  ...
  const peg$c208 = function(args: any): any { throw new Error(`NYI modifier types - ${text()}`); };
  const peg$c209 = function(elements: any): any { return options.factory.makeTupleTypeName(text(), elements) };
  const peg$c210 = function(innerT: any): any { return options.factory.makeTypeNameTypeName(text(), innerT); };
  const peg$c211 = function(name: any): any { return options.factory.makeBuiltinStructTypeName(text(), name); };
  const peg$c212 = "[";
  ...
  const peg$c217 = function(path: any): any { return options.factory.makeModuleTypeName(text(), path[0]) };
