...
export const msg05 = new BuiltinStructType(
    "msg",
    new Map([
...
export const msg06 = new BuiltinStructType(
    "msg",
    new Map([
        ["data", [types.bytesCalldata, ">=0.4.13"]],
        ["sender", [types.addressPayable, ">=0.4.13"]],
        ["sig", [types.bytes4, ">=0.4.13"]],
        ["value", [types.uint, ">=0.4.13"]],
        ["gas", [types.uint, "<0.5.0"]]
    ])
...
export const block = new BuiltinStructType(
    ...
    new Map([
        ...
        [
            "blockhash",
            [new BuiltinFunctionType(undefined, [types.uint], [types.bytes32]), "<0.5.0"]
        ],
...
export const globalBuiltins = new BuiltinStructType(
    ...
    new Map([
        ...
        [
            "keccak256",
            [new BuiltinFunctionType(undefined, [types.bytesMemory], [types.bytes32]), ">=0.4.13"]
        ],
        [
            "sha256",
            [new BuiltinFunctionType(undefined, [types.bytesMemory], [types.bytes32]), ">=0.4.13"]
        ...
        [
            "ripemd160",
            [new BuiltinFunctionType(undefined, [types.bytesMemory], [types.bytes20]), ">=0.4.13"]
        ],
        [
            "ecrecover",
            [
        ...
        [
            "log2",
            [
                new BuiltinFunctionType("log2", [types.bytes32, types.bytes32, types.bytes32], []),
                "<0.8.0"
            ]
        ],
        [
